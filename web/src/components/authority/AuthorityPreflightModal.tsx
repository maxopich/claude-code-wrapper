    ...
    >
      <div className="gate-modal modal-surface authority-preflight-modal">
        ...
        <p className="gate-modal-help">
          {isAggregate
            ? 'Resolved authority for each participant project — the SDK will load these settings layers when each agent spawns. Each participant loads its own files according to its Trust setting, so review per-project before starting the run.'
