...
function trackedDeps(): { deps: ShutdownDeps; calls: string[] } {
  ...
  const deps: ShutdownDeps = {
    ...
    closeLogger: () => calls.push('closeLogger'),
...
describe('[security] createShutdown', () => {
  test('closeAllQueries runs, and runs before the process exits', () => {
  ...
  test('the full teardown order is the one index.ts had', () => {
  ...
  test('a second signal during shutdown is ignored', () => {
  ...
  test('the tracked deps actually record — anti-vacuity', () => {
