...
| [`managed-agents.md`](managed-agents.md)           | the copy engine's symlink rule and size caps, the `.git` exclusion, credentials in the clear, the four editable config kinds, the delete's ordering                                                                                                                                                                                                            | `server/src/managed_*.ts`                                                                             |
